...
public class VideoActivity extends AppCompatActivity {
    public static final String ACCOUNT_SID = "AC5be905740d9d8f45f5af8936fd2f4975";
    public static final String API_KEY_SID = "SK61610617e52a8d29d3a7c5b2a9405532";
    public static final String API_KEY_SECRET = "WyEZCRkQgMWc9azbm9UYNGPkYlJC5d5c";
    ...
    private void setAccessToken() {
        if (!BuildConfig.USE_TOKEN_SERVER) { //generates a token based on the userName given
            // Create a VideoGrant
    ...
    private void connectToRoom(String roomName) {
         ...
         * published. If unset, the default is true.
         */
